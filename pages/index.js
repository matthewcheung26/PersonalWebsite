  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      <main className="bg-white px-10 ">
        <section className='pt-44 w-screen bg-gradient-to-r from-orange-400 to-indigo-400 relative top-20 left-0 -ml-10'>

          <nav class="bg-white px-2 sm:px-4 py-3 fixed w-full -top-1 left-0 border-b border-gray-200 backdrop-filter backdrop-blur-md bg-opacity-20">
        ...
        <section>
          <div class="w-screen px-4 py-12 -ml-10 space-y-8 overflow-hidden sm:px-6 lg:px-8 bg-gradient-to-r from-orange-400 to-indigo-400">
